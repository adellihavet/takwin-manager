...
import { X, ChevronRight, ChevronLeft, Database, LayoutDashboard, Users, Table, FileText, CheckCircle2, Edit3 } from 'lucide-react';
...
const TOUR_STEPS = [
  {
    ...
    content: "هذه المنصة مصممة لمساعدتك في إدارة الدورة التكوينية البيداغوجية باحترافية. هذه الجولة السريعة ستعرفك على أهم الوظائف.",
    icon: <CheckCircle2 className="w-16 h-16 text-dzgreen-500" />,
  },
  {
    title: "1. لوحة القيادة والإعدادات",
    content: "ابدأ دائماً من هنا. قم بضبط بيانات المؤسسة (الولاية، المركز)، وتحديد عدد الأفواج لكل تخصص. كما يمكنك إدارة قائمة الأساتذة المكونين.",
    icon: <LayoutDashboard className="w-16 h-16 text-blue-400" />,
  },
  {
    title: "2. إدارة المتكونين",
    content: "قم باستيراد قائمة الأساتذة (ملف CSV) أو إضافتهم يدوياً. استخدم زر 'التوزيع الآلي' لتقسيمهم على الأفواج بالتساوي وبشكل عادل بضغطة زر واحدة.",
    icon: <Users className="w-16 h-16 text-pink-400" />,
  },
  {
    title: "3. توليد التوزيع الزمني",
    content: "هنا يحدث السحر! تقوم الخوارزمية بتوزيع المقاييس زمنياً مع مراعاة عدم تضارب القاعات والأساتذة، واحترام الحجم الساعي القانوني لكل دورة.",
    icon: <Table className="w-16 h-16 text-purple-400" />,
  },
  {
    title: "4. التعديل اليدوي (جديد)",
    content: "هل تحتاج لتغيير حصة؟ استخدم قسم 'تعديل' لسحب وإفلات الحصص. النظام ذكي جداً وسينبهك فوراً باللون الأحمر إذا كان الأستاذ مشغولاً في التوقيت الجديد.",
    icon: <Edit3 className="w-16 h-16 text-amber-400" />, 
  },
  {
    title: "5. التقارير والحوصلة",
    content: "لا داعي لكتابة التقارير يدوياً. المنصة تنشئ تقارير دورية ونهائية جاهزة للطباعة، مع إمكانية الإملاء الصوتي للملاحظات البيداغوجية.",
    icon: <FileText className="w-16 h-16 text-indigo-400" />,
  },
  {
    title: "تنبيه هام جداً: حفظ البيانات",
    content: "التطبيق يعمل على المتصفح. لضمان عدم ضياع عملك عند غلق الصفحة، يجب عليك ضغط زر 'حفظ قاعدة البيانات' (في لوحة القيادة) بانتظام. احتفظ بالملف لاستيراده لاحقاً.",
